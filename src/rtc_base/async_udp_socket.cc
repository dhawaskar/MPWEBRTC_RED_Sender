...
void AsyncUDPSocket::OnReadEvent(AsyncSocket* socket) {
  ...
  SignalReadPacket(this, buf_, static_cast<size_t>(len), remote_addr,//sandy Reading is happening and do not know path id so just put 1
                   (timestamp > -1 ? timestamp : TimeMicros()),1);
}
