...
constexpr char RtpExtension::ksandyUri[]; //Mp-WebRTC
//constexpr char RtpExtension::kMpFlowIDUri[]; //Mp-WebRTC
constexpr char RtpExtension::kMpFlowSeqNumUri[]; //Mp-WebRTC
constexpr char RtpExtension::kMpTransportSequenceNumberUri[];//Mp-WebRTC
...
bool RtpExtension::IsSupportedForAudio(absl::string_view uri) {
  return uri == webrtc::RtpExtension::kAudioLevelUri ||
         ...
         uri == webrtc::RtpExtension::ksandyUri || //Mp-WebRTC
         //uri == webrtc::RtpExtension::kMpFlowIDUri || //Mp-WebRTC
         uri == webrtc::RtpExtension::kMpFlowSeqNumUri || //Mp-WebRTC
         uri == webrtc::RtpExtension::kMpTransportSequenceNumberUri ||//Mp-WebRTC
