...
class RtpRtcpInterface : public RtcpFeedbackSenderInterface {
 public:
  ...
  virtual void OnPacketsAcknowledged(
      rtc::ArrayView<const uint16_t> sequence_numbers,int pathid) = 0;
  ...
  virtual int32_t RemoteNTP(uint32_t* received_ntp_secs,
                            ...
                            uint32_t* rtcp_timestamp,int pathid) const = 0;
  ...
  virtual int32_t RTT(uint32_t remote_ssrc,
                      ...
                      int64_t* avg_rtt,
                      int64_t* min_rtt,
                      int64_t* max_rtt,int pathid) const = 0;
  ...
  virtual void GetSendStreamDataCounters(
      ...
      StreamDataCounters* rtx_counters,int pathid) const = 0;
  ...
  // that pair.
  virtual std::vector<ReportBlockData> GetLatestReportBlockData(int pathid) const = 0;
  ...
  virtual void SendNack(const std::vector<uint16_t>& sequence_numbers,int pathid) = 0;
  ...
  virtual bool StorePackets(int pathid) const = 0;
