...
struct RtcpStatistics {
  ...
  uint8_t      subflowfractionlost_p=0;
  uint8_t      subflowfractionlost_s=0;
  int32_t packets_lost = 0;  // Defined as a 24 bit signed integer in RTCP
  int32_t packets_lost_p = 0;  // Defined as a 24 bit signed integer in RTCP
  int32_t packets_lost_s = 0;
  uint32_t extended_highest_sequence_number = 0;
  uint32_t extended_highest_sequence_number_p = 0;
  uint32_t extended_highest_sequence_number_s = 0;
  uint32_t jitter = 0;
  uint32_t jitter_p = 0;
  uint32_t jitter_s = 0;
